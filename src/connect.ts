...
// In development, use a global variable to save the MongoDB connection across hot-reloads
...
export async function getDb(): Promise<Db> {
  const client = await clientPromise;
  return client.db('todo-app'); // Ensure the database name matches your MongoDB setup
}